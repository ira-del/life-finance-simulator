...
// L'app ne charge aucune ressource externe côté client (polices auto-hébergées
// via next/font, pas d'analytics, pas de CDN) — la CSP peut donc rester
// stricte sur presque tout. 'unsafe-inline' reste nécessaire sur script-src
// car Next.js (App Router) injecte des scripts inline pour l'hydratation en
